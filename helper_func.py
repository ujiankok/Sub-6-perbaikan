...
from config import ADMINS, FORCE_SUB_CHANNEL, FORCE_SUB_GROUP, FORCE_SUB_CHANNEL2, FORCE_SUB_GROUP2, FORCE_SUB_CHANNEL3, FORCE_SUB_GROUP3
...
subsgc3 = filters.create(subsgroup3)
